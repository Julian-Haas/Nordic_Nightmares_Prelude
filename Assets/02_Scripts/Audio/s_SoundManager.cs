...
public class s_SoundManager : MonoBehaviour
{
    ...
    private static s_SoundManager _SoundManagerInstance;
    ...
    private void Awake()
    {
        ...
        //Debug.LogError($"Singleton Soundmanager erfolgreich {_masterVolume}  ; {_sfxVolume}  ; {_musicVolume}");
    ...
    void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        {
            _gameManager._playedLoadingScreens = true;
