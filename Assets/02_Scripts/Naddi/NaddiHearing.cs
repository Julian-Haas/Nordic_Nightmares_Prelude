...
public class NaddiHearing : MonoBehaviour
{
    ...
    public float GetMinValumeModifyer {
        get {
            return minVolumeModifyer;
        }
    }
    public float GetHalfVolumeModifyer {
        get {
            return maxVolumeModifyer / 2;
        }
    }
    public float GetMaxValumeModifyer {
        get {
            return maxVolumeModifyer;
        }
    }
    public float GetSoundSum {
        get {
            return _soundSum;
        }
    }
